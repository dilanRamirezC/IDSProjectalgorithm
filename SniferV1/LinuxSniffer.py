...
#unpack ethernet frame - ! for network (big-endian)
def ethernet_frame(data):
  dest_mac, src_mac, proto = struct.unpack('! 6s 6s H',data[:14])
  return get_mac_addr(dest_mac),get_mac_addr(src_mac), socket.htons(proto), data[14:]

#Return propely formatted MAC addres(ie AA;BB;CC;DD;)
...
def tcp_segment(data):
  ...
  return src_port, dest_port, sequence, acknowledgment, flag_urg, (offset_reserved_flags & 16) >> 4, flag_psh, flag_rst, flag_syn, flag_fin, data[offset:]
